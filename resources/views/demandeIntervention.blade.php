...
<head>
    <title>Demmande d'intervention</title>
    <meta charset="utf-8" />
                                                ...
                                                <ul class="scrollbar scroll_dark max-h-240">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="{{('img/avtar/03.jpg')}}" alt="user3">
                                                                </div>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="{{('img/avtar/01.jpg')}}" alt="user">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="{{('img/avtar/04.jpg')}}" alt="user2">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="{{('img/avtar/05.jpg')}}" alt="user5">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="{{('img/avtar/06.jpg')}}" alt="user6">
                                                                </div>
                                                                <div class="notify-message">
                        ...
                        <div class="row formavlidation-wrapper">
                                ...
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title" style=" color: #0C349D; font: 2rem 'AR DARLING', sans-serif;  margin: 0 auto; ">Formulaire de demande d'intervention</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        {{ csrf_field() }}
                                            ...
                                            @endif
                                                 ...
                                                 <div class="form-group">
                                                <label class="control-label" for="ice">Votre ICE </label>
                                                <div class="mb-2">
                                                    <input type="text" class="form-control" name="ice" value="{{ $interventions->ICE}}" required="">
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group ">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" name="date1" placeholder=""  class="form-control inputmask" required="">
                                            ...
                                            <fieldset disabled>
                                            <div class="form-group">
                                                <label class="control-label" for="disabledTextInput">Nom/Prénom du demandeur </label>
                                                <div class="mb-2">
                                                    <input type="text" class="form-control" id="disabledTextInput" name="name" value="{{ $interventions->nom}} {{$interventions->prenom}}" required="">
                                                </div>
                                            </div>
                                            </fieldset>
                                            <div class="form-group ">
                                                <label class="control-label" for="date">Votre numéro de téléphone</label>
                                                <div class="mb-2">
                                                    <input type="text" placeholder="" name="num"  class="form-control inputmask" required="">
                                                    <span class="font-14 text-muted">(066) 666-6666</span>
                                                </div>
                                            </div>
                                            
                                             <div class="form-group ">
                                                 <label class="control-label" for="mat">Matériels concernés</label>
                                                 <div class="mb-2">
                                                 
                                                    <select  class="form-control" name = "mat" >
                                                    <option>choisir </option>
                                                    @foreach($materiel as $materiels)
                                                    <option >{{$materiels->nom_mat}} =>ID: {{$materiels->id_mat}}</option>
                                                    @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" for="desc">Description précises de votre demande</label>
                                                <div class="mb-2">
                                                    <textarea  class="form-control"  name="desc" placeholder="..." required="" >
                                                    </textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Univers High Tech</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <p style="text-align: justify;">Pour tout problème avec votre informatique :
                                         panne, ralentissement, perte de données, problèmes de connection...
                                         remplissez le formulaire ci-dessous pour demander une intervention. Nous vous recontacterons dans les meilleurs délais pour convenir d'un rendez-vous
                                           à votre domicile. Vous pouvez également nous contacter par téléphone : 
                                         au	+212 5 28 21 20 29. N'oubliez pas de laisser vos coordonnées !</p>
                                    </div>
                                </div>
                            </div>
