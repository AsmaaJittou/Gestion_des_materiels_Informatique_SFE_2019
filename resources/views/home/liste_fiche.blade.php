                                                ...
                                                <ul class="scrollbar scroll_dark max-h-240">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="{{('img/avtar/02.jpg')}}" alt="user2">
                                                                </div>
                                                                <div class="notify-message">
                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li><a href="interventionTechnicien" aria-expanded="false"><i class="nav-icon ion ion-ios-clipboard-outline"></i><span
                            ...
                            <li><a href="mail-inbox.html" aria-expanded="false"><i class="nav-icon ti ti-email"></i><span
                                        class="nav-title">Contacter admin</span></a> </li>  
                                        <li><a href="interventionTechnicien" aria-expanded="false"><i class="nav-icon ion ion-ios-clipboard-outline"></i><span
                                        class="nav-title">liste des Fiche d'intervention </span></a> </li> 
                        </ul>
                    </div>
                    <!-- end sidebar-nav -->
                </aside>
                                   ...
                                   <div class="ml-auto d-flex align-items-center">
                                       <nav>
                                           <ol class="breadcrumb p-0 m-b-0">
                                               ...
                                               <li class="breadcrumb-item active text-primary" aria-current="page">fiche_intervention</li>
                                           </ol>
                                       </nav>
                                   </div>
                                            ...
                                            <table id="latestjobs" class="table table-borderless table-striped jobportal-table mb-0">
                                                ...
                                                <tbody class="text-muted">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <span class="mr-2 mb-2 mr-sm-0 mb-sm-0 badge badge-dark-inverse">{{ $object->etat}}</span>
