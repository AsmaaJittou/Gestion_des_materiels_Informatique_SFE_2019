                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-sm-2 p-20">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="nav-link">
                                                        <a href="page-pricing.html">contacer utilisateur</a>
                                                    </li>
                                        ...
                                        <div class="page-account-profil pt-5">
                                            <div class="profile-img text-center rounded-circle">
                                                ...
                                                <div class="bg-img m-auto">
                                                                <img src="{{ asset('img/' . $utilisateur->image) }}" class="img-fluid" alt="users-avatar">
                                                            </div>
...
@endif
                                                                ...
                                                                <div class="form-group col-md-12 ">
                                                                    ...
                                                                    <input type="text" class="form-control" name='tel' value="{{$utilisateur->tel}}">
...
@endif
                                                                ...
                                                                <div class="form-group col-md-12 ">
                                                                    <label for="email1">CIN</label>
                                                                    <input type="text" class="form-control" name='CIN' value="{{$utilisateur->CIN}}">
                                                                </div>
                                                                <div class="form-group col-md-12 ">
                                                                <fieldset disabled>
                                                                
                                               <label for="disabledTextInput">ICE</label>
                                                <input type="text" id="disabledTextInput" class="form-control" name='ICE' value="{{ $utilisateur->ICE }}">
                                                                </fieldset></div>
                                                               
                                                                <div class="form-group col-md-12 ">
                                                                    <label for="email1">Adresse d'entreprise</label>
                                                        ...
                                                        <center>   <button type="submit" class="btn btn-primary" style=" background-color: #032E9C;" >Modifier</button>
                                                        </center>  </form>
                                                    </div>
                                                </div>
                                            </div>
