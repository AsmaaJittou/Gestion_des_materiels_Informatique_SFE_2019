                                ...
                                <div class="card card-statistics h-100 m-b-0">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-heading">
                                            <h4 class="card-title" style=" color: #0C349D; font: 2rem 'AR DARLING', sans-serif;  margin: 0 auto; ">votre liste des materiels achetés</h4>
                                        </div>
                                        ...
                                        @if ($message = Session::get('success'))
                                            ...
                                            <table class="table table-borderless mb-0" >
                                                <thead class="bg-light">
                                                    <tr>
                                                        <th style=" color: #0C349D;">ID</th>
                                                        <th style=" color: #0C349D;">Materiel</th>
                                                        
                                                        <th style=" color: #0C349D;">Numéro</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="text-muted mb-0">
                                                  @foreach($materiel as $materiels)
                                                    <tr>
                                                        <td>{{$materiels->id_mat}}</td>
                                                        <td>{{$materiels->nom_mat}}</td>
                                                       
                                                        <td>{{$materiels->numero}}</td>
