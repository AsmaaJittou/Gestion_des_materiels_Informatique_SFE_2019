                ...
                <nav class="navbar navbar-expand-md">
                    ...
                    <div class="navbar-header d-flex align-items-center">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="{{('img/hightech.png')}}" class="img-fluid logo-desktop" alt="logo" />
                            <img src="{{('img/hightech.png')}}" class="img-fluid logo-mobile" alt="logo" />
                        </a>
                    </div>
                                                ...
                                                <ul class="scrollbar scroll_dark max-h-240">
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                ...
                                                                <img src="{{asset('img/' . $technicien->image) }}" alt="avtar-img">                                                                </div>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="{{ asset('img/' . $technicien->image)  }}" alt="user">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="{{asset('img/' . $technicien->image) }}" alt="user2">
                                                                </div>
                                                                <div class="notify-message">
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">demande_intervention</li>
                                            </ol>
                                        </nav>
                                    </div>
                                ...
                                <div class="card card-statistics h-100 m-b-0">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-heading">
                                            <h4 class="card-title" style=" color: #0C349D; font: 2rem 'AR DARLING', sans-serif;  margin: 0 auto; ">Les interventions demandé par Admin </h4>
                                        </div>
                                        <div class="dropdown">
                                    ...
                                    <form method="post" action="list/print-pdf">
                                    {{ csrf_field() }}
                                            ...
                                            <table class="table table-borderless mb-0">
                                                ...
                                                @foreach($intervention as $interventions)
                                                    <tr>
                                                        ...
                                                        <td>{{$interventions->nom_materiel}}</td>
                                                        <td>{{$interventions->date}}</td>
                                                        <td>{{$interventions->description}}</td> 
                                                        <td> 
                                                        <form action="list/print-pdf" method="post">
                                                        {{ csrf_field()}}
                                                        <input name="idHidden" value="{{$interventions->id}}" type="hidden">
                                                        <button type="submit" class="btn btn-primary" name="signup" value="Sign up">Imprimer</button>
                                          </form><td>
