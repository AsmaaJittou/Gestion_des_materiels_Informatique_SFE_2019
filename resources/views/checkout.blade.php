                        ...
                        <div class="row formavlidation-wrapper">
                            ...
                            <div class="col-xl-6">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <form action="list/print-pdff" method="post">
                                        {{ csrf_field() }}
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nom complet</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputEmail3" value="{{$client->nom}} {{$client->prenom}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputPassword3" class="col-sm-3 col-form-label">Email</label>
                                                <div class="col-sm-9">
                                                    <input type="email" class="form-control" id="inputPassword3" value="{{$client->email}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Adresse</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputEmail3" value="{{$client->Adresse}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputPassword3" class="col-sm-3 col-form-label">ZIP</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputPassword3" placeholder="entrer le zip">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputPassword3" class="col-sm-3 col-form-label">Date d'expiration</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputPassword3" placeholder="entrer la date d'expiration">
                                                </div>
                                            </div>
                                            <fieldset class="form-group">
                                                <div class="row">
                                                    <div class="col-form-label col-sm-3 pt-3">Mode de paiement</div>
                                                    <div class="col-sm-9">
